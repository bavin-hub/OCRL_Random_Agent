...
def run_train(task_id: str, cfg: TrainConfig, log_dir: Path) -> None:
  ...
  if cfg.use_world_model:
    ...
    if cfg.world_model_checkpoint:
        print(f"[INFO] Loading World Model weights from {cfg.world_model_checkpoint}")
        world_model.load_state_dict(torch.load(cfg.world_model_checkpoint, map_location=device, weights_only=True))
